...
Phase 7 extends zgard's targeting model with tag-based filtering, allowing users to select repositories by semantic labels defined in config.yaml.
...
*(Removed — command has been eliminated from the CLI.)*
